...
function _draw()
  ...
  elseif mode == 1 then
   ...
   -- end debug
    ...
    for i=-1,1 do
      for j=-1,1 do
        print(score, 32+i-modx, 50+j,2)
      end
    end
    print(score,32-modx,50,7)
  end
end
  ...
  for enemy in all(enemies) do
    ...
    if check_collision(
      ...
      if enemy.type == "stormtrooper" and not enemy.about_to_die and p.state == "dash" then
        ...
        score+=(100 + (score_multiplier * 100))
        --enemy_die(enemy)
      elseif enemy.type == "stormtrooper" and not enemy.about_to_die and p.state == "kicking" then
        ...
        score+=(125 + (score_multiplier * 125))
        combo_add()
      end
      if enemy.type == "laser" then
      ...
      for enemy2 in all(enemies) do
        if enemy2.type == "stormtrooper" and check_collision(
            ...
            {x=enemy2.x+enemy2.hbox.xmod,
             ...
             explody_fx(enemy2)
             enemy_die(enemy2)
             score+=(200 + (score_multiplier * 200))
             combo_add()
        end
      end
    end
